...
<html>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="roman.php">Les livre</a>
    ...
    <div class="album py-5 bg-light">
        <div class="container">
            ...
            <tbody>
            <?php foreach($mesproduits as $roman): ?>
                <tr>
                ...
                <td><?= substr($roman->description, 0, 100); ?></td>
                <td><a href="editer.php?id=<?= $roman->id ?>"><img src="editer.jpg" style=width:40px;></a></td>
                </tr>      
<?php endforeach; ?>
