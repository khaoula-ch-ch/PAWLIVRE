...
<html lang="en">
  ...
  <nav id="menu">
        ...
        <ul class="menu-all">
        <li class="menu-item">
           <a class="nav-link " href="" role="button" > <?= $panierenfant->count() ;?></a>
        </li>
        <li class="menu-item"><a  href="panierenfant.php" > <image src="../panier1.png" style=width:20px;></a></li>
            ...
            <li class="menu-item"><a href="enfant.php">Home</a></li>
        ...
        <form method="post" action="panierenfant.php">
        ...
        <div class="container">
            ...
            if(empty($ids)){
                ...
                $mesproduits = $DBenfant->query('SELECT * FROM enfant WHERE id IN ('.implode(',' , $ids).') ');
            }
       ...
       <tr>
                ...
                <td><?= $enfant->nom?></td>
                <td>
                <img src="<?= $enfant->image?>" style="width: 15%">
                </td>
               
                <td style="font-weight: bold; color: green;"><?= $enfant->prix ?>DA</td>
                
                <td> <input type="text" name="panierenfant[quantity][<?= $enfant->id ;?>]" value ="<?=$_SESSION['panierenfant'][$enfant->id];?>"></td>
                <td><a href="panierenfant.php?delpanierenfant=<?= $enfant->id ?>"><img src="../supprimer.png" style=width:30px; > </a></td>
                </tr>      
        <?php endforeach ?> 
        ...
        <th> </th> <th> </th> <th> </th> <th> </th>
                <th>Totale :</th>
                <th> <?= number_format($panierenfant->totale(),2,',','');?></th>
            </tr>
